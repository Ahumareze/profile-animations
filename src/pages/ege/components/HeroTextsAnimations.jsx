...
function HeroTextsAnimations({startAnimations}) {
    ...
    return (
        <div className='h-0 max-w-[700px] overflow-hidden text-xl font-medium text-white/90 text-center space-y-2 mt-5' ref={containerRef}>
            <p className='relative top-10 opacity-0' id='ege-paragraph-item'>Lorem Ipsum is simply dummy text of the printing</p>
            <p className='relative top-10 opacity-0' id='ege-paragraph-item'>standard dummy text ever since the 1500s</p>
            <div className='pt-5'>
                <div 
