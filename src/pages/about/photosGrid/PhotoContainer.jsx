...
function PhotoContainer({photo, handleHover}) {
    return (
        <div className='h-full w-full bg-white overflow-hidden relative' onMouseEnter={handleHover}>
            ...
            <div className='absolute top-0 left-0 h-full w-full bg-white' id='photo-grid-cover' />
        </div>
    )
}
