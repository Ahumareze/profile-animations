  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-blue-100 select-none bg-center bg-no-repeat bg-cover" style={{ backgroundImage: `url(${skin})` }}>
      ...
      <div className="flex space-x-8">
        ...
        <a href="https://github.com/Ahumareze/web-animations/tree/main/web-animations/src/pages/eyesTracker" target="_blank">
            <div className="flex items-center gap-2 px-5 py-2 bg-black text-white rounded-full mt-20 hover:scale-105 duration-300 ease-in-out">
                <p className="font-medium hidden md:flex">Get Code</p>
                <FaGithub />
            </div>
        </a>
    </div>
