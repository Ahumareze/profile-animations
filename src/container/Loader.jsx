        ...
        <div>
            <div className={`h-screen w-full fixed top-0 left-0 z-[10001] flex flex-col gap-10 ${backdrop}`} id='loader-container'>
                <div className='flex-1 w-full flex flex-col items-center justify-center'>
                    ...
                    <h1 className='text-5xl font-extrabold'>PUSHING THE LIMITS OF THE WEB</h1>
                </div>
                <div className='p-10'>
                    <div className='h-[10px] w-full bg-red-100 rounded-full flex items-center justify-start'>
                        <div className='w-[20px] h-full rounded-full bg-red-500' id='loader-indicator' /><p className='text-3xl md:text-4xl relative right-2'>🏀</p>
                    </div>
                </div>
            </div>
        </div>
